node {
    ...
    stage('Code Quality')
    {
        ...
        def msbuild = tool name: 'MSBuild', type: 'hudson.plugins.sonar.MsBuildSQRunnerInstallation'
            ...
            bat "\"${tool name: 'MSBuild', type: 'msbuild'}\" example.sln /t:Rebuild"
            bat "\"${msbuild}\"\\SonarQube.Scanner.MSBuild.exe end /d:sonar.login=dbd529efca4c5cf0dccf3922e67ca4f95183d05a"
